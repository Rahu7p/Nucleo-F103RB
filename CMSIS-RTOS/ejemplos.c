...
void USER_GPIO_Init(void){
	...
	//pin PC13 (User BUTTON) as input floating: CNF13=01, MODE13=00
...
void StartTask1(void const * argument){
	...
	for(;;)
	{
		printf("Task 1\r\n");
		//osDelay(10);
		osDelay(10 - (osKernelSysTick() - (10 * counter++)));
		//HAL_Delay(10);
	}
}
...
void StartTask1(void const * argument){
	...
	for(;;)
	{
		...
		printf("Task 1\r\n");
		priority++;
		osThreadSetPriority(Task2Handle, priority);
		//osDelay(10 - (osKernelSysTick() - (10 * counter++)));
	}
}
