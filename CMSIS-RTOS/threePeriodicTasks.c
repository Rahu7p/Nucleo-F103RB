...
#define PERIOD_T2		4000
#define PERIOD_T3		2000
...
{
  /* USER CODE BEGIN 1 */
  static uint8_t numTask1 = 1;
  static uint8_t numTask2 = 2;
  static uint8_t numTask3 = 3;
  /* USER CODE END 1 */
  ...
  osThreadDef(task1, Task1, osPriorityHigh, 0, 128);
  TaskHandle1 = osThreadCreate(osThread(task1), &numTask1);
  osThreadDef(task2, Task2, osPriorityNormal, 0, 128);
  TaskHandle2 = osThreadCreate(osThread(task2), &numTask2);
  osThreadDef(task3, Task3, osPriorityAboveNormal, 0, 128);
  TaskHandle3 = osThreadCreate(osThread(task3), &numTask3);
