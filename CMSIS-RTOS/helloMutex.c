...
/**
  ...
  * the value of a global variable (count), this shared resource is protected with 
  * a Mutex. Task3 should print the value of count.
  *
  ******************************************************************************
  */
...
void Task3(void const * argument){
	...
	for(;;)
	{
		...
		temp = osKernelSysTick() - (2000 * counter++);
		osDelay(2000 - temp);
	}
}
/* USER CODE END 4 */
